<template>
  <div class="node-openobserve px-4 py-3 rounded-lg shadow-2xl min-w-[180px] border-2" :class="nodeClasses">
...
const nodeClasses = computed(() => {
  // Default classes
  const baseClasses = 'border-orange-400/30'
...
const statusIndicatorClasses = computed(() => {
  ...
  switch (props.data.executionStatus) {
    case 'completed': return 'bg-orange-400'
