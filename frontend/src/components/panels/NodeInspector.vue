<template>
  <div v-if="visible" class="fixed inset-0 z-50 flex items-center justify-center">
    ...
    <div class="relative max-w-6xl w-full mx-4 h-[80vh] bg-slate-900 rounded-lg shadow-2xl border border-slate-700/50 flex">
      ...
      <!-- Content -->
      <div class="mt-20 flex-1 flex">
        <!-- Input Panel -->
        <div class="flex-1 border-r border-slate-700/50">
        ...
        <div class="flex-1">
          ...
          <div class="p-4 h-full overflow-auto">
            <div v-if="hasError" class="mb-4 p-3 bg-red-900/20 border border-red-500/50 rounded-lg">
